...
const banner3 = cfonts.render((`Yuno|Bot V2`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Yuno"
const packname = "Criador: @Loost"

const chyt = "557591756291@s.whatsapp.net";
const nit = "554491712954@s.whatsapp.net";
const supre = "557591711655@s.whatsapp.net";
